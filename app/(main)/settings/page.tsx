    ...
    <main className="flex flex-col gap-8 p-6">
      ...
      <Tabs defaultValue="profile" className="flex flex-col md:flex-row gap-6">
        ...
        <TabsList className="flex md:flex-col h-full overflow-x-auto md:w-60 gap-2 p-2 rounded-xl bg-muted/50 border no-scrollbar">
          {["profile", "general", "timer", "notifications", "tracking", "appearance"].map((tab) => (
            ...
            <TabsContent value="timer" className="space-y-6 max-w-md">
              ...
              <div className="grid gap-4">
                <div>
                  ...
                  <Input type="number" value={defaultSession} onChange={(e) => setDefaultSession(Number(e.target.value))} />
                </div>
                <div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Switch checked={adaptiveTimer} onCheckedChange={setAdaptiveTimer} />
                </div>
              </div>
            </TabsContent>
            ...
            <TabsContent value="tracking" className="space-y-6 max-w-md">
              ...
              <div className="grid gap-4">
                <div className="flex justify-between items-center">
                  ...
                  <Switch checked={trackDistractions} onCheckedChange={setTrackDistractions} />
                </div>
                <div className="flex justify-between items-center">
