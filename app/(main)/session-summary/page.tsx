  ...
  return (
    <main className="flex-1 flex flex-col items-center justify-center px-6 py-12">
      <div className="max-w-2xl w-full space-y-8">
        ...
        {/* Focus Score Card */}
        <div className="bg-gradient-to-br from-secondary/20 to-secondary/10 rounded-3xl p-8 border border-secondary/30 flex flex-col items-center">
        ...
        <div className="bg-card rounded-3xl p-8 border border-border space-y-4">
          {sessionData && (
            <div className="flex items-center gap-3 text-lg mb-4 pb-4 border-b border-border">
              <span>📝</span>
          ...
          <div className="flex items-center gap-3 text-lg">
            ...
            <span className="font-medium">{sessionData?.duration ?? 42} min</span>
          </div>
          ...
          <div className="flex items-center gap-3 text-lg">
            ...
            <span className="font-medium">{sessionData?.energy ?? "Medium"}</span>
          </div>
        </div>
        ...
        <div className="flex justify-center pt-4">
          <Link
            href="/"
            className="px-12 py-4 bg-primary text-primary-foreground rounded-2xl font-semibold hover:bg-primary/90 transition-all duration-300 glow-primary"
          >
            Save & Go Home
          </Link>
        </div>
